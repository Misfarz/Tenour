  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900/20 via-neutral-950 to-neutral-950">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-neutral-900/60 border border-neutral-800/80 backdrop-blur-xl rounded-2xl p-8 shadow-2xl shadow-purple-950/20">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white tracking-tight">Buyer Sign In</h1>
